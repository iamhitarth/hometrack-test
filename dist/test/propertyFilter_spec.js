...
describe('PropertyFilter', function () {
    ...
    var filteredProperties = propFilter.getFiltered(reqObj.payload, 'htv', 'completed');

    it('will return a list of properties', function () {
        assert(filteredProperties);
    });

    it('will only return matching properties', function () {
...
//# sourceMappingURL=propertyFilter_spec.js.map